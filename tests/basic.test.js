import { and,or, evenOrOdd, greeting, welcome,  operaciones,oo} from '../src/basic';
//import {compOne, compTwo   } from "../src/basic";
//import {} from '../src/basic';
//Ejercicio 1
...
describe('Comparaciones en Javascript', () => {
    it("usando ===", () => {
        const number = 20;
        //completa la asignación usando number y el comparador ===(falso)
